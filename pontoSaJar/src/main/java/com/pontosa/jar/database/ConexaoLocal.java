...
public class ConexaoLocal {
    ...
    private static final String url = "jdbc:mysql://172.17.0.2:3306/PontoSa?allowPublicKeyRetrieval=true&useSSL=false?allowPublicKeyRetrieval=true&useSSL=false";
